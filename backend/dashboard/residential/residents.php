...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    redirect('/backend/dashboard/residential/residents.php');
}
...
<main class="container section-padding">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo APP_BASE; ?>/backend/dashboard/residential/index.php" class="btn btn-outline-light">رجوع</a>
  </div>
  ...
  <div class="feature-card mb-4">
    <form method="get" class="row g-3">
      ...
      <div class="col-md-4 d-flex align-items-end">
        ...
        <a href="<?php echo APP_BASE; ?>/backend/dashboard/residential/residents.php" class="btn btn-outline-secondary">إعادة تعيين</a>
      </div>
    </form>
  </div>
