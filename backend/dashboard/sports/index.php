...
<main class="container section-padding">
  ...
  <div class="row g-4">
    <div class="col-md-6" data-aos="fade-up">
      <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/backend/dashboard/sports/facilities.php">
    ...
    <div class="col-md-6" data-aos="fade-up">
      <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/backend/dashboard/sports/bookings.php">
        <div class="feature-card h-100">
