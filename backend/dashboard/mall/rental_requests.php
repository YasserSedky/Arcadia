...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect(APP_BASE . '/backend/dashboard/mall/rental_requests.php');
}
...
<main class="container section-padding">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo APP_BASE; ?>/backend/dashboard/mall/index.php" class="btn btn-outline-light">رجوع</a>
    </div>
