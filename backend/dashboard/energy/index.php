...
<main class="container section-padding">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
      <?php if ($tab === 'solar'): ?>
        <a href="<?php echo APP_BASE; ?>/backend/dashboard/energy/new_array.php" class="btn btn-gradient"><i class="bi bi-plus-lg"></i> إضافة منظومة</a>
      <?php elseif ($tab === 'stations'): ?>
        <a href="<?php echo APP_BASE; ?>/backend/dashboard/energy/new_station.php" class="btn btn-gradient"><i class="bi bi-plus-lg"></i> إضافة محطة</a>
      <?php endif; ?>
    </div>
  </div>
        ...
        <div class="col-md-6" data-aos="fade-up">
          <div class="feature-card text-start">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <a href="<?php echo APP_BASE; ?>/backend/dashboard/energy/readings.php?array_id=<?php echo (int)$a['id']; ?>" class="btn btn-outline-light">القراءات</a>
            </div>
            <hr>
        ...
        <div class="col-md-6" data-aos="fade-up">
          <div class="feature-card text-start">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div>
                <a href="<?php echo APP_BASE; ?>/backend/dashboard/energy/edit_station.php?id=<?php echo (int)$s['id']; ?>" class="btn btn-outline-light btn-sm">تعديل</a>
...
<form id="deleteForm" method="post" action="<?php echo APP_BASE; ?>/backend/dashboard/energy/delete_station.php" style="display: none;">
