...
<main class="container section-padding" style="max-width:840px;">
  <div class="feature-card">
    ...
    <form method="post" action="<?php echo APP_BASE; ?>/backend/dashboard/energy/save_array.php" class="row g-3">
      <div class="col-md-6">
      ...
      <div class="col-12 d-grid d-md-flex gap-2">
        ...
        <a class="btn btn-outline-light" href="<?php echo APP_BASE; ?>/backend/dashboard/energy/index.php">رجوع</a>
      </div>
    </form>
  </div>
</main>
