...
$array = $arr->fetch();
if (!$array) {
  redirect('/backend/dashboard/energy/index.php');
}
...
<main class="container section-padding">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo APP_BASE; ?>/backend/dashboard/energy/index.php" class="btn btn-outline-light">رجوع</a>
  </div>

  <div class="feature-card mb-4">
    <form method="post" action="<?php echo APP_BASE; ?>/backend/dashboard/energy/save_reading.php" class="row g-3">
