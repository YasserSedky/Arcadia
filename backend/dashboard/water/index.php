...
<main class="container section-padding">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo APP_BASE; ?>/backend/dashboard/water/new_station.php" class="btn btn-gradient"><i class="bi bi-plus-lg"></i> إضافة محطة</a>
        </div>
    </div>
            ...
            <div class="col-md-6" data-aos="fade-up">
                <div class="feature-card text-start">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?php echo APP_BASE; ?>/backend/dashboard/water/edit_station.php?id=<?php echo (int)$s['id']; ?>" class="btn btn-outline-light btn-sm">تعديل</a>
...
<form id="deleteForm" method="post" action="<?php echo APP_BASE; ?>/backend/dashboard/water/delete_station.php" style="display: none;">
