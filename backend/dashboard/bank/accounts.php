...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  redirect('/backend/dashboard/bank/accounts.php');
}
...
<main class="container section-padding">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo APP_BASE; ?>/backend/dashboard/bank/index.php" class="btn btn-outline-light">رجوع</a>
  </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex gap-1 flex-wrap">
                  ...
                  <?php endif; ?>
                  <a href="<?php echo APP_BASE; ?>/backend/dashboard/bank/transactions.php?account_id=<?= (int)$acc['id'] ?>" class="btn btn-xs btn-primary" style="font-size: 0.75rem; padding: 0.2rem 0.4rem;" title="المعاملات">
