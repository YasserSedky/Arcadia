...
<main class="container section-padding">
    ...
    <div class="row g-4 mt-3">
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/mall/tenants.php">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/mall/units.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/mall/venues.php">
                <div class="feature-card h-100">
        ...
        <div class="col-12" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/mall/bookings.php">
                <div class="feature-card h-100">
