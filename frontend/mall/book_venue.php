...
if (!$venue) {
    ...
    redirect(APP_BASE . '/frontend/mall/venues.php');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        redirect(APP_BASE . '/frontend/mall/bookings.php');
    } catch (Exception $e) {
...
<main class="container section-padding">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo APP_BASE; ?>/frontend/mall/venues.php" class="btn btn-outline-light">رجوع</a>
    </div>
...
<script>
    document.querySelector('input[name="date"]').addEventListener('change', function(e) {
        ...
        fetch(`<?php echo APP_BASE; ?>/frontend/mall/get_bookings.php?venue_id=${venueId}&date=${date}`)
