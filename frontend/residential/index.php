...
<main class="container section-padding">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if (!empty($user)): ?>
            ...
            <?php endif; ?>
        <?php else: ?>
            <a href="/backend/auth/login.php" class="btn btn-outline-primary">تسجيل الدخول</a>
        <?php endif; ?>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showUnitOwner(unitId, unitCode) {
        ...
        fetch('<?php echo APP_BASE; ?>/frontend/residential/get_unit_owner.php?unit_id=' + unitId)
