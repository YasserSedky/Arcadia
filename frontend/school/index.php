...
<main class="container section-padding">
    ...
    <div class="row g-4 mt-3">
        <div class="col-md-3" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/school/classes.php">
        ...
        <div class="col-md-3" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/school/stages.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-3" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/school/students.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-3" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/school/teachers.php">
                <div class="feature-card h-100">
