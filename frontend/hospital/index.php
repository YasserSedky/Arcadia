...
<main class="container section-padding">
    ...
    <div class="row g-4">
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/clinics.php">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/book_appointment.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/appointments.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/tests.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/followups.php">
                <div class="feature-card h-100">
        ...
        <div class="col-md-4" data-aos="fade-up">
            <a class="text-decoration-none" href="<?php echo APP_BASE; ?>/frontend/hospital/pharmacy.php">
                <div class="feature-card h-100">
