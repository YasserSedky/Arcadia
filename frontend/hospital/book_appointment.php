...
<main class="container section-padding" style="max-width:720px;">
    <div class="feature-card auth-card" data-aos="fade-up">
        ...
        <form method="post" action="<?php echo APP_BASE; ?>/frontend/hospital/book_appointment.php" class="row g-3">
            <div class="col-12">
            ...
            <div class="col-12 d-grid d-md-flex gap-2 auth-actions">
                ...
                <a class="btn btn-outline-light" href="<?php echo APP_BASE; ?>/frontend/hospital/index.php">الغاء</a>
            </div>
        </form>
    </div>
</main>
