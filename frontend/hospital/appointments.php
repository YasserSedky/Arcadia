...
if (isset($_GET['cancel_id']) && $patient_id) {
    ...
    redirect('/frontend/hospital/appointments.php');
}
                ...
                <div class="col-md-6" data-aos="fade-up">
                    <div class="feature-card h-100">
                        ...
                        <div class="d-flex gap-2">
                            <a class="btn btn-outline-light" href="<?php echo APP_BASE; ?>/frontend/hospital/appointments.php?cancel_id=<?php echo (int)$a['id']; ?>" onclick="return confirm('هل تريد إلغاء هذا الموعد؟');">إلغاء</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
