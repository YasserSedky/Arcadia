            ...
            <div class="col-md-6" data-aos="fade-up">
                <div class="feature-card h-100">
                    ...
                    <div class="d-flex gap-2">
                        <a class="btn btn-gradient" href="<?php echo APP_BASE; ?>/frontend/hospital/book_appointment.php?clinic_id=<?php echo (int)$c['id']; ?>">حجز كشف</a>
                        <a class="btn btn-outline-light" href="<?php echo APP_BASE; ?>/backend/dashboard/hospital/clinics.php">معلومات (للإدارة)</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
